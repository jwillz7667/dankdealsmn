...
-- CreateEnum
CREATE TYPE "PotencyUnit" AS ENUM ('PERCENT', 'MG');

-- CreateEnum
CREATE TYPE "Badge" AS ENUM ('DEAL', 'NEW', 'BEST');
...
-- CreateEnum
CREATE TYPE "PromoType" AS ENUM ('PERCENT_OFF', 'AMOUNT_OFF', 'FREE_DELIVERY');
...
CREATE TABLE "Product" (
    ...
    "thcValue" DECIMAL(6,2),
    "thcUnit" "PotencyUnit" NOT NULL DEFAULT 'PERCENT',
    "cbdValue" DECIMAL(6,2),
    "cbdUnit" "PotencyUnit" NOT NULL DEFAULT 'PERCENT',
...
CREATE TABLE "StoreSettings" (
    ...
    "freeDeliveryThresholdCents" INTEGER NOT NULL DEFAULT 7500,
    "minOrderCents" INTEGER NOT NULL DEFAULT 3000,
    "taxRateBps" INTEGER NOT NULL DEFAULT 1000,
    "defaultTipBps" INTEGER NOT NULL DEFAULT 1500,
    "deliveryEtaMinutes" INTEGER NOT NULL DEFAULT 45,
    "licenseNumber" TEXT NOT NULL DEFAULT 'MN-CAN-0421',
    "supportPhone" TEXT,
    "supportEmail" TEXT,
    "announcement" TEXT,
    "updatedAt" TIMESTAMP(3) NOT NULL,
